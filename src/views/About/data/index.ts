...
export const services = [
  {
    ...
    title: '2 Months of content available',
  },
  {
    icon: 'fas fa-paint-brush',
    title: 'Multiple Content Collections',
  },
  {
    icon: 'fas fa-bullseye',
    title: 'Personalized Captions and Hashtags',
  },
  {
    icon: 'fas fa-bolt',
    title: 'Advanced Dashboard and Content Calendar',
  },
  {
    icon: 'far fa-star',
    title: 'Ever-evolving with outstanding Customer Service',
  },
  {
    icon: 'far fa-handshake',
    title: 'We give back to our communities',
  },
];
